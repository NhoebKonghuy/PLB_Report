...
inner join adm_currency ac on ac.id = apd.currency_id   
    ...
    AV.VILLAGE_CODE ,
    AP.APPLICATION_NO,
    CASE WHEN TY.CODE IN ('00102','00103') THEN RIGHT(CAST(CCD.COLLATERAL_NAME AS VARCHAR), 4) 
    ELSE '...................................................................................................................................................................................' END AS HEAD_LAND_TITLE ,
    COL.COLLATERAL_TITLE,
    CASE WHEN CCD.COLLATERAL_NAME IS NULL THEN '..............'
		ELSE TRANSLATE(CCD.COLLATERAL_NAME,'1234567890','១២៣៤៥៦៧៨៩០') END AS COLLATERAL_NO,
    CASE WHEN COL.OWNER_NAME IS NULL THEN '...........' ELSE 
		COL.OWNER_NAME END AS OWNER_NAME,
